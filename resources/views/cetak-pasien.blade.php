...
<body>
  <header class="clearfix">
    <h1>Climays Poliklinik</h1>
    <div id="company" class="clearfix">
      <div>Rekam Medis</div>
      <div>Jl. Prof. Sudarto, Tembalang, Kec. Tembalang, Kota Semarang, Jawa Tengah 50275</div>
      <div>(024) 7473417</div>
      <div><a>climays@gmail.com</a></div>
    </div>
    <br>
  </header>
  <main>
  ...
  <footer>
    <h2>Semoga Lekas Sembuh, dan Sehat Selalu</h2>
  </footer>
</body>
